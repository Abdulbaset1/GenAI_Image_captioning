...
from utils import greedy_search, load_model  # Changed: import load_model
import requests
...
def load_artifacts():
    ...
    model = load_model(model_path, vocab_path, device)  # Fixed: using load_model from utils
...
def load_feature_extractor():
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    extractor = models.resnet50(weights=models.ResNet50_Weights.IMAGENET1K_V1)  # Fixed deprecated pretrained=True
